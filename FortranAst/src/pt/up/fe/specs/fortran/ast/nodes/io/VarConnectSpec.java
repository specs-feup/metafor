...
public class VarConnectSpec extends ConnectSpec {
    public static final DataKey<VarConnectSpecKind> KIND = KeyFactory.enumeration("kind", VarConnectSpecKind.class);

    public VarConnectSpec(DataStore data, Collection<? extends FortranNode> children) {
        super(data, children);
    }

    public VarConnectSpecKind getKind() {
        return get(KIND);
    }
